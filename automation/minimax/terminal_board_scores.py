""""Module stating the value of array win / loss / draw to the maximising player"""
...
class TerminalScore(Enum):
    ...
    from array winning score and added to array losing score, because we want to find the quickest/loss in either scenario.
    """
    MAX_WIN = 1000
    DRAW = 0
    MAX_LOSS = -1000
