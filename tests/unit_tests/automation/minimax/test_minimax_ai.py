...
# Fixtures used throughout test module
...
class TestMinimaxAncillaryMethodsThreeThree:
    ...
    # Tests for the _evaluate_terminal-board_to_maximising_player
    def test_evaluate_terminal_board_to_maximising_player_max_loss(self, three_three_game_with_minimax_player,
                                                                   human_player):

        # Note this is the current not winning board - the PLAYER TURN IS HUMAN
        three_three_game_with_minimax_player.playing_grid = np.array([
            [BoardMarking.EMPTY.value, BoardMarking.X.value, BoardMarking.X.value],
            [BoardMarking.EMPTY.value, BoardMarking.O.value, BoardMarking.O.value],
            [BoardMarking.EMPTY.value, BoardMarking.O.value, BoardMarking.EMPTY.value]
        ])
        search_depth = 5
        actual_score = three_three_game_with_minimax_player._evaluate_terminal_board_to_maximising_player(
                search_depth=search_depth, winning_player=human_player, draw=False
                )
        assert actual_score == BoardScore.GUARANTEED_MAX_WIN.value - search_depth

    def test_evaluate_terminal_board_to_maximising_player_max_win(self, three_three_game_with_minimax_player,
                                                                  minimax_player):

        # Note this is the current not winning board - the PLAYER TURN IS MINIMAX
        three_three_game_with_minimax_player.playing_grid = np.array([
            [BoardMarking.EMPTY.value, BoardMarking.O.value, BoardMarking.O.value],
            [BoardMarking.EMPTY.value, BoardMarking.X.value, BoardMarking.X.value],
            [BoardMarking.EMPTY.value, BoardMarking.X.value, BoardMarking.EMPTY.value]
        ])
        search_depth = 3
        actual_score = three_three_game_with_minimax_player._evaluate_terminal_board_to_maximising_player(
            search_depth=search_depth, winning_player=minimax_player, draw=False
        )
        assert actual_score == BoardScore.GUARANTEED_MAX_LOSS.value + search_depth

    def test_evaluate_terminal_board_to_maximising_player_draw(self, three_three_game_with_minimax_player):

        three_three_game_with_minimax_player.playing_grid = np.array([  # Note this is the current not winning board
            [BoardMarking.EMPTY.value, BoardMarking.X.value, BoardMarking.X.value],
            [BoardMarking.EMPTY.value, BoardMarking.O.value, BoardMarking.O.value],
            [BoardMarking.EMPTY.value, BoardMarking.O.value, BoardMarking.EMPTY.value]
        ])
        search_depth = 7
        actual_score = three_three_game_with_minimax_player._evaluate_terminal_board_to_maximising_player(
            search_depth=search_depth, winning_player=None, draw=True
        )
        assert actual_score == BoardScore.DRAW.value - search_depth

    # Test for _evaluate_non_terminal_board - note this has it's own testing module, just checking link here
    def test_evaluate_non_terminal_board_to_maximising_player(self, three_three_game_with_minimax_player):
        """
        Unit test that the evaluate_non_terminal board function has been correctly pulled through as a method in
        the minimax class, and can be called.
        """
        three_three_game_with_minimax_player.playing_grid = np.array([
            [BoardMarking.EMPTY.value, BoardMarking.EMPTY.value, BoardMarking.EMPTY.value],
            [BoardMarking.EMPTY.value, BoardMarking.EMPTY.value, BoardMarking.EMPTY.value],
        ...
        playing_grid_to_score = np.array([
            [BoardMarking.EMPTY.value, BoardMarking.EMPTY.value, BoardMarking.EMPTY.value],
            [BoardMarking.EMPTY.value, BoardMarking.O.value, BoardMarking.EMPTY.value],
            [BoardMarking.EMPTY.value, BoardMarking.EMPTY.value, BoardMarking.EMPTY.value]
        ])
        score = three_three_game_with_minimax_player._evaluate_non_terminal_board_to_maximising_player(
            playing_grid=playing_grid_to_score, search_depth=1, maximiser_has_next_turn=False
        )
        assert score > 0
