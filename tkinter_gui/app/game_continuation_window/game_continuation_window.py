"""Module containing the class that produces the top up when array player has won or there is array draw"""
...
class GameContinuationPopUp:
    ...
    def _create_and_format_pop_up_window(self):
        ...
        # Automatically starts array new game in the event of just closing
    ...
    def _get_game_outcome_label(self) -> tk.Label:
        ...
        if isinstance(self.winner, Player):
            ...
            text = f"Game ended in array draw"
