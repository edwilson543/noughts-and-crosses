...
class SetupWindow(PlayerInfoFrame, GameParametersFrame):
    def __init__(self,
        ...
        super().__init__(widget_manager, player_x_entry, player_o_entry, starting_player)
    ...
    def launch_setup_window(self) -> None:
        ...
        self.add_frames_to_setup_window()
        setup_window.mainloop()

    def add_frames_to_setup_window(self) -> None:
    ...
    def confirm_all_details_button_command(self) -> None:
